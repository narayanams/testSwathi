...
function makeCFXPreferences(e)
{
    var $this = $(e.target);
    if (!this.suggestion) {
        this.suggestion = $('<div class="passwordPreferences"> <div class="capsLock" id="psdPreferenceCapsLock" > Caps lock is on! Passwords are case sensitive </div> <div id="psdPreferenceCharsCountRule" class=""> Contain at least 8 characters </div> <div id="psdPreferenceCharsRule" class=""> Include at least 1 letter </div> </div>');
    }
...
function hideBreadcrumb() {
    $('.ProgressBarSteps').removeClass("active");
}
